...
macro(ctkMacroBuildLib)
  ...
  elseif(CTKAppLauncher_QT_VERSION VERSION_GREATER "5")
    QT6_WRAP_CPP(${prefix}_MOC_CXX ${${prefix}_MOC_SRCS})
    QT6_WRAP_UI(${prefix}_UI_CXX ${${prefix}_UI_FORMS})
    if(DEFINED ${prefix}_RESOURCES)
      QT6_ADD_RESOURCES(${prefix}_QRC_SRCS ${${prefix}_RESOURCES})
    endif()
  else()
